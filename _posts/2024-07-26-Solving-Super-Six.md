...
After running the optimisation we can verify for each triplet of variables whether $$p_{choice,S}$$ is equal to either $$p_{roll,S}$$ or $$p_{end,S}$$. If this verification passes, we know that these are indeed maximums and we solved the game.
